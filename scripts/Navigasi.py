...
def callbackeny(data):
    global dataen2
    dataen2 = data.data
    rospy.loginfo(rospy.get_caller_id() + ' Nilai encoder 2 : %d',data.data)
...
def get_current_position(pre_x,pre_y,pre_tangent,pre_deg):
    ...
    rospy.loginfo(rospy.get_caller_id() + ' data jumlah perubahan tangen = %d', sum_set_tangent)   
    ...
    return [current_x,current_y,set_tangent,set_deg]
